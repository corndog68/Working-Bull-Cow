...
{
	const FString HIDDEN_WORD = "jimny"; // this must be an isogram
...
EGuessStatus FBullCowGame::CheckGuessValidity(FString Guess) const    //if this is broken then check headerfile for type ie int, string etc
{
